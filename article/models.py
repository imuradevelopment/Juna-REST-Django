...
class Article(models.Model):
    ...
    author = models.ForeignKey(User, verbose_name="著者", on_delete=models.PROTECT, to_field="user_id")
...
class Comment(models.Model):
    ...
    commenter = models.ForeignKey(User, verbose_name="コメンター", on_delete=models.PROTECT, to_field="user_id")
...
class Reply(models.Model):
    ...
    replyer = models.ForeignKey(User, verbose_name="コメンター", on_delete=models.PROTECT, to_field="user_id")
    created_at = models.DateTimeField('作成日', default=timezone.now)
